...
export default class CircleProgressView extends Component {
    static defaultProps = {
        ...
        progress: 0,
        raduis: 15,
        progressColor: "#458BEB",
        progressBaseColor: "#e5e5e5",
        centerViewMode: true
    };
            ...
            <View>
                <Surface width={this.state.size} height={this.state.size}>
                    <Group>
                        <Shape
                            d={path0}
                            stroke={this.props.progressBaseColor}
